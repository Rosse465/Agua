...
<html>
    <head>
        ...
        <script>
            ...
            function buscarProd(){
                var search = document.buscar.search.value;

                if(search){
                    document.buscar.method='post';
                    document.buscar.action='Funciones/buscar.php';
    ...
    <body>
        ...
        <form name="buscar">                
            ...
            <input id="search" type="text" name="search" autocomplete="off" placeholder="Buscar producto">
            <input id="boton" type="submit" value="Buscar" onclick="buscarProd();  return false;">
            <br>
        </form>
